...
dollars pour la NSA\cite{budget}, en même temps\ldots), mais nous allons voir
...
citoyens ordinaires. Le Guardian croit savoir\cite{Tempora} que le programme ne
...
la messagerie Yahoo!\cite{yahoocam}, sans chercher précisément des cibles
pré-enregistrées.

\newthought{Le programme est} supposé avoir capturé des millions d'images, à
raison de cinq images par seconde\cite{latribune}, dont de nombreuses images à
...
% \vspace{0.5cm}
\begin{figure}
\centerline{\includegraphics[height=8cm]{gchq.jpg}}
