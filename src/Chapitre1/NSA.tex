...
\newthought{Ce n'est qu'à} la fin des années 1960\cite{ZDNET} qu'ECHELON fut
...
dans le monde, selon un document de Snowden datant de 2012\cite{Stations}.

\vspace{0.7cm}
\begin{figure}[h]
\centerline{\includegraphics{carte.jpg}}
...
\begin{figure}[h]
\centerline{\includegraphics[height=10cm]{flow.png}}
